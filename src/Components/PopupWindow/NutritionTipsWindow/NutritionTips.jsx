  ...
  return (
    <>
      ...
      <Button
        ...
        text="Learn what to eat while training"
        onClick={() => setToggle(!toggle)}
      />
      {toggle && (
        <div className="popup  bg-slate-800" id="nutritionWindow">
          <h2 className="text-2xl text-slate-100 w-fit">Nutrition tips</h2>
          <Button
...
export default NutritionTipsWindow;
